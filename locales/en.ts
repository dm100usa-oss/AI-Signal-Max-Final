const en = {
  ...
  success: {
    ...
    quickDetailLead: "If you need:",
    quickDetailItem1: "Answers to the key questions — what keeps your site out of AI answers and recommendations and away from new customers",
    quickDetailItem2: "Specific <b>Recommendations</b>",
    quickDetailItem3: "Step-by-step <b>Plan</b>",
    quickDetailItem4: "<b>Priority</b> of changes",
    quickDetailItem5: "Technical <b>Brief</b> for a developer",
    quickDetailAfter1: "We recommend moving on",
    quickDetailAfter2: "to the Detailed Check",
    quickDoneP4: "Part of the data is already collected during the quick check — so you get a special price:",
    quickPriceNew: "$19.99",
    quickPriceOld: "$30.00",
    quickPriceOff: "−33%",
    quickPriceNote: "Less than one hour of a specialist's work",
