const en = {
  ...
  success: {
    ...
    quickDoneP1: "We checked the site against 28 factors, grouped into 15 key parameters and 4 main directions, so the score is accurate and objective.",
    quickDoneP2: "Now you know how ready your site is to attract new clients through AI answers and recommendations.",
    quickDoneP3: "If you need specific recommendations, a step-by-step action plan and a technical brief for a developer — the Detailed check provides those answers.",
    quickDoneP4: "Since the Quick check is already done and part of the data is collected, the Detailed check is available to you at a special price — $19.99 instead of $30.00.",
