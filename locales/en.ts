const en = {
  ...
  quickPreview: {
    ...
    limitText: "The next ones will be available on the 1st of next month. You can continue right now by choosing one of the options below.",
    ...
    limitDetailedDesc: "A full site analysis, a step-by-step improvement plan, and a ready-to-use brief for your developer.",
