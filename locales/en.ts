const en = {
  ...
  success: {
    ...
    quickResultFactorsWords: ["key factor needs work", "key factors need work"],
    quickResultFactorsTail: "",
    quickResultDirectionsWords: ["direction needs special attention", "directions need special attention"],
