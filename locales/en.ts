const en = {
  ...
  quickPreview: {
    ...
    factorsExpress: [
      ...
      "Enough content for AI",
      "Are there signs of authority",
      "Will AI recommend your site",
    ],
    analyzingExpress: "Analyzing 10 factors and 4 areas",
  ...
  success: {
    ...
    siteLabel: "Website",
    tempDomainWarning: "Also: this site is on a temporary address (e.g. .vercel.app / .netlify.app). AI systems almost never recommend such addresses. A permanent domain of your own is needed.",
    ...
    quickDoneItem1: "28 parameters",
    quickDoneItem2: "15 key factors",
    quickDoneItem3: "4 main directions",
    quickResultTitle: "Based on the check:",
    quickResultAllGood: "Parameters, key factors, and main directions need no improvement.",
    quickResultTopAllGood: "Even an excellent result needs ongoing attention.",
    quickResultParamsWords: ["parameter needs improvement", "parameters need improvement"],
    quickResultParamsTail: "",
    quickResultFactorsWords: ["factor needs work", "factors need work"],
    quickResultFactorsTail: "",
    quickResultDirectionsWords: ["direction needs attention", "directions need attention"],
    quickResultDirectionsTail: "",
    quickResultTopWords: ["key factor needs", "key factors need"],
    quickResultTopTail: "minor but ongoing attention",
    quickObjectTitle: "What we checked",
    quickCheckDone: "Your quick check is complete",
    quickDetailLead: "If you need specific answers:",
    quickDetailItem1: "<b>Reasons</b> your site loses customers from AI answers",
    quickDetailItem2: "Specific <b>Recommendations</b>",
    quickDetailItem3: "Step-by-step <b>Plan</b>",
    quickDetailItem4: "<b>What to fix</b> first",
    quickDetailItem5: "<b>Where</b> you can save money",
    quickDetailItem6: "Technical <b>Brief</b> for a developer",
    quickDetailAfter: "This is the job of the <b>Detailed Check</b>",
    quickDoneP4: "Since the Quick check is already done and part of the data is collected, the Detailed check is available to <b>you</b> <b><span class=\"whitespace-nowrap\">at a special price:</span></b>",
    quickPriceNew: "$19.99",
    quickPriceOld: "$30.00",
    quickDoneUrlPlaceholder: "https://example.com",
    quickDoneButton: "Start Detailed check",
