const ru = {
  ...
  quickPreview: {
    ...
    limitTitle: "Вы использовали все 3 бесплатные проверки за этот месяц",
    placeholder: "https://example.com",
    errorInvalidUrl: "Введите корректный URL, включая https://",
    ...
    limitExpressDesc: "Общий процент готовности сайта и оценки по четырём ключевым направлениям, влияющим на его видимость в ответах и рекомендациях ИИ.",
