const ru = {
  ...
  quickPreview: {
    ...
    limitTitle: "Вы уже использовали все три бесплатные проверки, доступные в этом месяце",
    placeholder: "https://example.com",
    errorInvalidUrl: "Введите корректный URL, включая https://",
    limitText: "Бесплатная проверка снова будет доступна с 1-го числа следующего месяца.",
