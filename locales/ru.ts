const ru = {
  ...
  success: {
    ...
    quickDoneP1: "Мы проверили сайт по 28 факторам, объединённым в 15 ключевых параметров и 4 основных направления, чтобы оценка была точной и объективной.",
    quickDoneP2: "Теперь вы знаете, насколько сайт готов привлекать новых клиентов через ответы и рекомендации ИИ.",
    quickDoneP3: "Если вам понадобятся конкретные рекомендации, пошаговый план действий и техническое задание для разработчика — эти ответы даёт Детальная проверка.",
    quickDoneP4: "Поскольку Быстрая проверка уже выполнена и часть данных собрана, Детальная проверка доступна для вас по специальной цене — $19.99 вместо $30.00.",
