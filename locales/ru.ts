const ru = {
  ...
  quickPreview: {
    ...
    limitText: "Следующие будут доступны 1-го числа следующего месяца. Вы можете продолжить прямо сейчас, выбрав один из вариантов ниже.",
    ...
    limitDetailedDesc: "Полный анализ сайта, пошаговый план улучшений и готовое техническое задание для разработчика.",
    backHome: "На главную",
  },
