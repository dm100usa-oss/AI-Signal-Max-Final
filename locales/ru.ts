const ru = {
  ...
  success: {
    ...
    quickDoneP3: "Если вам нужны конкретные Рекомендации, пошаговый План действий и техническое Задание для разработчика, эти ответы даёт <b>Детальная проверка</b>.",
    ...
    quickIncludes1: "Рекомендации",
    quickIncludes2: "Пошаговый план",
    quickIncludes3: "ТЗ для разработчика",
