  ...
  success: {
    ...
    levels: {
      veryLow: {
        ...
        text: "Пока искусственному интеллекту трудно понять, чем занимается ваш сайт, поэтому он редко может рекомендовать его пользователям. Начинать стоит с базовых доработок.",
      },
      low: {
        title: "Сайт делает первые шаги к рекомендациям ИИ",
        text: "Искусственный интеллект уже видит часть информации о вашем сайте, но пока понимает её неполно. Сейчас важно усилить базовые элементы, чтобы сайт стал значительно понятнее для ИИ.",
      },
      medium: {
        title: "Хороший прогресс. Сайт уже наполовину готов к рекомендациям ИИ",
        text: "У сайта уже есть прочная основа. Многие важные элементы присутствуют, но часть сигналов пока выражена недостаточно. После доработок сайт сможет значительно повысить свои шансы попадать в рекомендации ИИ.",
      },
      good: {
        title: "Хороший результат. Сайт уже уверенно движется к рекомендациям ИИ",
        text: "У сайта уже есть хорошая основа, и многие важные элементы работают правильно. После доработки нескольких факторов сайт сможет значительно усилить свои позиции и чаще попадать в рекомендации ИИ.",
      },
      veryGood: {
        title: "Очень хороший результат. Сайт уже совсем близок к рекомендациям ИИ",
        text: "Ваш сайт уже имеет сильную основу и уверенно конкурирует за место в рекомендациях искусственного интеллекта. Осталось усилить несколько важных элементов, которые помогут ИИ ещё чаще выбирать именно ваш сайт.",
      },
      excellent: {
