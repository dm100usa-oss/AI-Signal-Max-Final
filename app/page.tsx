  ...
  return (
    <main className="mx-auto max-w-2xl px-6 pt-20 pb-16 transition-opacity duration-700">
      ...
      <div className="flex flex-col items-center mb-10">
        ...
        {/* НОВЫЙ БЛОК — рейтинг слева, звезды по центру, отзывы справа */}
        <div className="w-full flex items-center justify-between text-neutral-700 text-sm font-medium tracking-tight mb-2">
