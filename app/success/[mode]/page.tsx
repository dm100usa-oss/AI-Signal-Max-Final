              ...
              <div>
                ...
                {allGood ? (
                  ...
                  <ul className="space-y-2">
                    {rows.map((r, i) => (
                      <li key={i} className="flex gap-3 leading-relaxed">
                        <span className="mt-1.5 shrink-0 flex items-center">
                          <span
                            className="h-3.5 w-3.5 rounded-full shadow-[0_2px_5px_rgba(0,0,0,0.25),inset_0_1px_2px_rgba(255,255,255,0.4)]"
                            style={{ backgroundColor: "#f59e0b" }}
                          />
                          <span
                            className="h-3.5 w-3.5 rounded-full -ml-2 shadow-[0_2px_5px_rgba(0,0,0,0.25),inset_0_1px_2px_rgba(255,255,255,0.4)]"
